...
const Distributor = () => {
  return (
    <section className="bg-[url(/distributor-bg.jpg)] text-white py-12 lg:py-24 h-auto bg-cover bg-no-repeat text-center relative">
      <div className="absolute inset-0 bg-black opacity-50"></div>
      <div className="relative space-y-3 lg:space-y-14">
        <div className="max-w-2xl px-3 md:px-0 lg:max-w-3xl m-auto space-y-3">
          <h1
        ...
        <div className=" text-center h-auto ">
          <Image
            ...
            height={1000}
            alt=""
            className=" m-auto object-contain mb-6 max-h-[307px]"
          />
